...
function Models() {
  ...
  // Cube Icon SVG Component for Empty State
  const CubeIcon = () => (
    <div className="w-24 h-24 flex items-center justify-center bg-blue-200 rounded-lg">
      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M32 18L18 26V42L32 50L46 42V26L32 18Z" fill="white" stroke="black" strokeWidth="2"/>
        <path d="M18 26L32 34L46 26" stroke="black" strokeWidth="2"/>
        <path d="M32 34V50" stroke="black" strokeWidth="2"/>
        <path d="M25 14L39 22L53 14L39 6L25 14Z" fill="white" stroke="black" strokeWidth="2"/>
        <path d="M39 22V38" stroke="black" strokeWidth="2"/>
        <path d="M53 14V30" stroke="black" strokeWidth="2"/>
      </svg>
    </div>
  );
  ...
  const EmptyState = ({ message }) => (
    <div className="flex flex-col items-center justify-center py-16">
      <CubeIcon />
      <h3 className="text-xl font-bold text-gray-800 mt-6 mb-2">No models found</h3>
  ...
  const renderContent = () => {
    if (activeTab === 'Your Work') {
      return <EmptyState message="You are not currently signed in. Sign in to see your work" />;
    }
    
    if (activeTab === 'Shared With You') {
      return <EmptyState message="You are not currently signed in. Sign in to see models shared with you" />;
    }
      ...
      <>
        <div className="flex items-center border-t rounded-none p-4">
          <div className="flex items-center space-x-4 flex-grow">
            ...
            {/* Model Details */}
            <div className="flex-grow">
              <div className="font-semibold text-gray-800">Gemma 3 · gemma-3-4b-it</div>
              <div className="text-sm text-gray-500">
                Google · Transformers · Gemma is a family of lightweight, state-of-the-art open models from Google, built from the same research and technology used to create the Ge...
              </div>
              <div className="text-sm text-gray-500 mt-1">1 user</div>
