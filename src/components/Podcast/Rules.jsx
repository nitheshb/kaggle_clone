        ...
        <div ref={section3Ref} className="mb-8">
          ...
          <div className="pl-4 space-y-6">
            <div ref={section11Ref}>
              <p className="text-gray-700 font-medium mb-2">3.1 ELIGIBILITY</p>
              <p className="text-gray-700 font-medium mb-1">a.</p>
              <p className="text-gray-700 mb-2">
            ...
            <div ref={section12Ref}>
              <p className="text-gray-700 font-medium mb-2">3.2 SPONSOR AND HOSTING PLATFORM</p>
              <p className="text-gray-700 font-medium mb-1">a.</p>
              <p className="text-gray-700">
            ...
            <div ref={section13Ref}>
              <p className="text-gray-700 font-medium mb-2">3.3 COMPETITION PERIOD</p>
              <p className="text-gray-700 font-medium mb-1">a.</p>
              <p className="text-gray-700">
            ...
            <div ref={section14Ref}>
              <p className="text-gray-700 font-medium mb-2">3.4 COMPETITION ENTRY</p>
              <p className="text-gray-700 font-medium mb-1">a.</p>
              <p className="text-gray-700 mb-2">
            ...
            <div ref={section15Ref}>
              <p className="text-gray-700 font-medium mb-2">3.5 INDIVIDUALS AND TEAMS</p>
            ...
            <div ref={section16Ref}>
              <p className="text-gray-700 font-medium mb-2">3.6 SUBMISSION CODE REQUIREMENTS</p>
            ...
            <div ref={section17Ref}>
              <p className="text-gray-700 font-medium mb-2">3.7 DETERMINING WINNERS</p>
              <p className="text-gray-700 font-medium mb-1">a.</p>
              <p className="text-gray-700 mb-2">
