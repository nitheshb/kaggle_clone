  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center px-4 py-3">
        <div className="flex items-center space-x-3">
          ...
          <div className="text-gray-500 text-xs uppercase tracking-wide">
            KAGGLE · PLAYGROUND PREDICTION COMPETITION · 13 DAYS TO GO
          </div>
        </div>
      ...
      <div className="flex justify-between px-4 py-6">
        <div>
          <h1 className="text-4xl font-bold text-gray-800">Predict Podcast Listening Time</h1>
          {/* Increased font size from default to text-base (16px) */}
          <p className="text-gray-600 text-base mt-2">Playground Series - Season 5, Episode 4</p>
        </div>
