...
//                 <h2 className="text-xl font-bold text-gray-800">Sample Code for VGGT Inference</h2>
...
//                 </div>
//               </div>
//               <div className="text-gray-600 mt-1">Updated 9d ago</div>
//               <div className="text-gray-600 mt-1">
//                 <span className="text-gray-800">3 comments</span> · Image Matching Challenge 2025
//               </div>
//             </div>
//           </div>
//         </div>
...
//             <div className="flex-grow">
//               <div className="flex justify-between">
//                 <h2 className="text-xl font-bold text-gray-800">Guide / Visualization / Statistics / Approach</h2>
//                 <div className="flex items-center">
//                   <div className="flex items-center border rounded-l-full rounded-r-full overflow-hidden">
//                     <button className="px-2 py-1 bg-white border-r">
//                       <ChevronUp size={16} />
...
//               </div>
//               <div className="text-gray-600 mt-1">
//                 <span className="text-gray-800"></span> · Updated 4d ago
//               </div>
//               <div className="text-gray-600 mt-1">
...
// Baseline: DINO+ALIKED+LightGLUE improved</h2>
//                 <div className="flex items-center">
//                   <div className="flex items-center border rounded-l-full rounded-r-full overflow-hidden">
//                     <button className="px-2 py-1 bg-white border-r">
//                       <ChevronUp size={16} />
