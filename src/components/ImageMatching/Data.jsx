  ...
  return (
    <div className="text-gray-800">
      ...
      <p className="mb-6">
       ...
       Building a 3-D model of a scene given an unstructured collection of images taken around it is a longstanding problem in computer vision research.<br></br> Your challenge in this competition is to generate 3-D reconstructions from image sets showing different types of scenes and accurately pose those<br></br>images. This year, we’re challenging you to determine how images should be grouped together or discarded, in addition to reconstructing 3D scenes.<br></br> 
