            ...
            <div className="flex justify-between">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col items-center">
                  <div className="flex items-center rounded-full border border-gray-200 overflow-hidden mb-1">
                    <button 
                      className="py-0.5 px-1.5 bg-gray-100 border-r border-gray-200 hover:bg-gray-200"
                      onClick={() => handleUpvote(topic.id)}
                    >
                      <ChevronUp size={12} className="text-gray-500" />
                    </button>
                    ...
                    <button 
                      className="py-0.5 px-1.5 bg-gray-100 border-l border-gray-200 hover:bg-gray-200"
                      onClick={() => handleDownvote(topic.id)}
                    >
                      <ChevronDown size={12} className="text-gray-500" />
                    </button>
